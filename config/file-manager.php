...
return [
     ...
     * [] - no restrictions
     */
    'allowFileTypes' => ['SVG','WEBP','webp','JPG', 'GIF', 'PNG', 'JPEG', 'BMP', 'GIF', 'PDF', 'DOC', 'DOCX', 'XLS', 'XLSX', 'jpg', 'gif', 'png', 'jpeg', 'bmp', 'gif', 'svg', 'pdf', 'doc', 'docx', 'xls', 'xlsx','txt','MP3','mp3','M4A','m4a','FLAC','flac','AAC','aac','WMA','wma','WAV','wav','MP4','mp4','MOV','mov','WMV','wmv','AVI','avi','FLV','flv','MKV','mkv'],
