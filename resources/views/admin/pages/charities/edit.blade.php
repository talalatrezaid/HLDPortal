            ...
            <div class="col-lg-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-hand-holding-heart nav-icon"></i> Edit Charity</h3>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('charities.update', $charity['id']) }}" method="post" class="needs-validation" novalidate>
                            @csrf
                            @method("PUT")
                            <div class="container">
                                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control @error('charity_name') is-invalid @enderror" id="fname" placeholder="Full Charity Name (e.g; Islamic Relief...)" value="{{old('charity_name',$charity->charity_name)}}" name="charity_name">
                        ...
                        <select class="form-control" name="role">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control @error('user_name') is-invalid @enderror" id="user_name" placeholder="slug (e.g; /islamicrelief)" value="{{old('user_name',$charity->user_name)}}" name="user_name">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control @error('email') is-invalid @enderror" id="email" placeholder="Email" value="{{old('email',$charity->email)}}" name="email">
                                    @if($errors->has('email'))
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="is_active" class="form-control form-control ">
                                        <option value="1" {{($charity['is_active'] == 1) ? "selected" : ""}}>Active</option>
                                        <option value="0" {{($charity['is_active'] == 0) ? "selected" : ""}}> Ban </option>
                                    </select>
